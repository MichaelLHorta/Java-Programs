...
public class Blackjack extends ConsoleProgram
{
    ...
    private String getPlayerMove()
    {
        while(true)
        {
            String move = readLine("Enter move (hit/stand/double down): ");
    ...
    /*
    private String canISplit()
    {
        if(hasSameValue() == true)
        {
            return "You Split your cards.";
        }
        System.out.println("You can't Split, try something else.");
    }
    
    private boolean hasSameValue()
    {
        int firstCardValue = (player.get(0)).getValue();
        int secondCardValue = (player.get(1)).getValue();
        
        if(firstCardValue == secondCardValu)
        {
            return true;
        }
    }
    */
    ...
    private boolean playerTurn(Hand player, Deck deck)
    {
        while(true)
        {
            ...
            {
                BET = BET * 2;
                System.out.println("your new bet is " + BET);
                Card c = deck.deal();
                System.out.println("Your card was: " + c);
                player.addCard(c);
                System.out.println("Player's hand");
    ...
    public void run()
    {
        ...
        while(true)
        {
            ...
            if(bankroll > 0)
            {
                ...
                {
                    System.out.println();
                    System.out.println("The Boss needs to see you. Come with me.");
                    System.out.println();
                    System.out.println("Thanks for playing!");
                    break;
                }
            ...
            {
                System.out.println();
                System.out.println("You have no more money left in your bankroll.");
                System.out.println();
                System.out.println("Thanks for playing!");
                break;
            }
